...
//todo: You can also check out type converters
                ...
                todoListDatabase = Room.databaseBuilder(context,
                        ...
                        .addCallback(object : Callback() {
                            override fun onCreate( db: SupportSQLiteDatabase) {
                                super.onCreate(db)
                                //todo: race condition with loading initial data from UI
                        ...
                        .allowMainThreadQueries()//todo: i will remove this later, database are not supposed to be called on main thread
                        .build()
            }
